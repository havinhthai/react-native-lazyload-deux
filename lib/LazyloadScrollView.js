...
import { ScrollView as AfScrollView } from 'react-native-af-video-player';
...
class LazyloadScrollView extends Component {
  ...
  render() {
    const CustomScrollView = this.props.fsVideo ? AfScrollView : ScrollView;

    return this.props.name ? <CustomScrollView
      {...this.props}
